...
export const createViewHistoryMangaCustom = async (organizationId: number, mangaSlug: string, ip: string) => {
...
export const createViewHistoryChapter = async (organizationId: number, mangaSlug: string, chapterNumber: number, ip: string) => {
