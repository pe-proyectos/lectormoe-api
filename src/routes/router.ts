...
import { router as recommendationRouter, adminRouter as recommendationAdminRouter } from './recommendation/index'
...
import { router as hilosRouter, publicRouter as hilosPublicRouter, modRouter as hilosModRouter, webhookRouter as hilosWebhookRouter, workUrlRouter as hilosWorkUrlRouter } from './hilos'
...
export const router = () => async (app: Elysia) => {
  ...
  app.use(recommendationAdminRouter())
